...
import { SIGN_IN_MERCHANT_PUBLIC_API_ROUTE, PUBLIC_BASE_URL, RESET_PASSWORD_API_ROUTE } from '@src/services/routes';
import axios from 'axios';
import { useRouter } from "next/router";
import { useState } from 'react';
import { successAlert, errorAlert } from "@src/services/alert";

const MerchantResetPasswordForm = () => {
            ...
            <Head>
             ...
             <main>
                ...
                <div className={signinStyles.formContainer} style={{display:'flex',}}>
                    ...
                    <hr style={{width:'28%', height:'3px', backgroundColor: '#E0E0E0', border: 'none'}}/>
                    {
                        loading ? (  <button className={signinStyles.submitButtonMerchant} type='submit'>
                        <p className="pt-3">Resetting Your Password</p>
                    </button>) : (  <button className={signinStyles.submitButtonMerchant} type='submit' onClick={(e) => handleResetPassword(e)}>
...
export {MerchantResetPasswordForm};