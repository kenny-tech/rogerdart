...
import { PAGE_ROUTE_SIGN_IN, PUBLIC_BASE_URL, VERIFY_ACCOUNT } from '@src/services/routes';
        ...
        <div>
            ...
            <div className={verifyCodeStyles.digitGroup}>
                <div className="card border-0 shadow p-3 mb-5 bg-white rounded">
                    ...
                    {
                        isLoading ? (<button className={verifyCodeStyles.verifyOtpButton} type='submit' disabled={true}> <p className="pt-3">Confirming</p>
                        <EllipseAnimation /></button>) : (<button className={verifyCodeStyles.verifyOtpButton} type='submit' onClick={handleCodeSubmission}>Confirm</button>) 
                    }
