            ...
            res.status(409).json({
                              ...
                              <td style="padding:40px;">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr>
                                    ...
                                    <p style="font-size:15px; color:#455056; line-height:20px; margin:8px 0 30px;">Hi <strong>${req.body.business_name}</strong>,</p>
              ...
              transporter.sendMail(mailOptions, function(error, info){
                if (error) {
                    ...
                    res.status(201).json({
                        success:true,
                        message:`Hi ${req.body.business_name}, your account was created successfully. Check your mail @: ${req.body.email} to verify your account.`
                    })
                }
            });
        }
