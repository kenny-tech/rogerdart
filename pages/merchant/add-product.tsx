...
import AddProductForm from "@src/component/Merchant/Products/add-product";
                                        ...
                                        <div className={productStyles.heading}>
                                            <div className="row">
                                                <div className="col-md-3 mt-3 mb-3">
                                                    <p style={{color: '#000', fontSize: '18px', whiteSpace: 'nowrap', marginLeft: '30px'}}>Add Product</p>
                                                </div>
                                            </div>  
                                        </div>
...
export default withAuthMerchant(AddProduct);